...
<header>
    <nav>
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="#">Turinio valdymo sistema</a>
            </li>

            <?php foreach ($navigations as $navigation) { ?>
                <li>
                <a class="nav-link"  href="#"><?php echo $navigation->getTitle(); ?></a>
                </li>
            <?php } ?>
    ...
    <?php }?>
    <?php if (isLoggedIn()) {?>
        <a id="logout" href="<?php echo BASE_URL; ?>/actions/logout.php">Atsijungti</a>
    <?php }?>
</header>
